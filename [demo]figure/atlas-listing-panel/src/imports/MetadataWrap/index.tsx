import svgPaths from "./svg-5x4xmnviu3";
...
export default function MetadataWrap() {
  return (
    <div className="content-stretch flex items-center pb-[8px] pl-[4px] pr-[8px] pt-[4px] relative size-full" data-name="Metadata Wrap">
      <Metadata />
    </div>
  );
}