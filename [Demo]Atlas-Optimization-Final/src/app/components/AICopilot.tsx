      ...
      <div className="p-[16px] border-t border-[#d8dada]">
        <div className="flex items-center gap-[8px]">
          <input
            ...
            className="flex-1 px-[12px] py-[8px] bg-[#f8f7f7] border border-[#ebecec] rounded-[6px] font-['PingFang_SC:Regular',sans-serif] text-[12px] leading-[20px] text-[#3c4242] placeholder:text-[#999] focus:outline-none focus:border-[#830051]"
          />
          <button className="size-[32px] flex items-center justify-center bg-[#830051] rounded-[6px] hover:bg-[#6d0043] transition-colors active:scale-[0.96] transition-transform">
