...
export function SearchBar({
  ...
  let outerClasses = "flex h-[36px] items-stretch rounded-[6px] p-[2px] gap-[6px] border-[0.6px]";
  if (isFocused) {
  ...
  const innerClasses = `flex flex-1 items-center gap-[6px] rounded-[4px] ${innerBg} ${innerPadding}`;
